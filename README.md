...
Wenn Port 8080 bei dir besetzt ist, ist das normal. Der Client läuft hier auf **8081**.

Hinweis: docker-compose.override.yml ist für lokale Port-Einstellungen gedacht.
